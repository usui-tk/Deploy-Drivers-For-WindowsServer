...
```
Deploy-AMDChipsetDriverOnWindowsServer.ps1   (最も成熟した実装、 正本 r55)
Deploy-AMDGraphicsDriverOnWindowsServer.ps1  (graphics 固有の platform 検出、 r23)
Deploy-AMDNpuDriverOnWindowsServer.ps1       (4-tier installer 解決を持つ NPU script、 r6)
```
...
- **現リビジョン**: `chipset-2026.05.16-r55` (tag: `chipset-lock-release-and-log-aggregation-r55`)
...
- **現リビジョン**: `graphics-2026.05.16-r23` (tag: `graphics-lock-release-r23`)
...
- **現リビジョン**: `npu-2026.05.16-r6` (tag: `npu-secureboot-baseline-r6`)
