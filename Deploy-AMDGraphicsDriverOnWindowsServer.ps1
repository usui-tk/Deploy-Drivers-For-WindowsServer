...
.DESCRIPTION
    ...
    ====================================
    This script uses a SEPARATE workspace (C:\AMD-Graphics-WS), a
    SEPARATE certificate subject ('CN=AMD Graphics Driver Self-Sign
    ...'), and a SEPARATE WDAC supplemental policy ID. Running the
    chipset script first and the graphics script second produces TWO
    co-existing supplemental policies, both authorized to load self-
    signed kernel drivers. Neither overrides the other.
    ...
    [1] Working directory is fully separated.
        Default for THIS script: C:\AMD-Graphics-WS
...
param(
    ...
    # that workspace).
    [string]$WorkRoot      = 'C:\AMD-Graphics-WS',
...
$Script:ScriptVersion = 'graphics-2026.05.17-r25'
$Script:ScriptTag     = 'graphics-citool-json-and-pnputil-259-r25'
...
function Show-Help {
    ...
    Write-Host '                             Default: C:\AMD-Graphics-WS'
