...
$Script:ScriptVersion = 'graphics-2026.05.17-r26'
$Script:ScriptTag     = 'graphics-logfile-and-temp-workspace-r26'
...
#####################################################################
# SECTION 0.25: Optional console transcript capture (r26+)
#####################################################################
