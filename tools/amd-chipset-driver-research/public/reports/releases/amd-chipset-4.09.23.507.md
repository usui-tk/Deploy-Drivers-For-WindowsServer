# AMD Chipset Software 4.09.23.507 - Windows Server static analysis
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Windows Server 2016 | 24 | 0 | 0 | 0 | 0 | 73 | 0 |
| Windows Server 2019 | 24 | 0 | 0 | 0 | 0 | 73 | 0 |
| Windows Server 2022 | 24 | 0 | 0 | 0 | 0 | 73 | 0 |
| Windows Server 2025 | 24 | 0 | 0 | 0 | 0 | 73 | 0 |

## Device-driver details

### `d3_Data1.cab_805a7fef6dd0\amdas4.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdcir.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdgpio2.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdgpio3.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdi2c.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdiov.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdmicropep.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdpcidev.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdpmf.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdppmpf.inf`

- Driver version: `8.0.0.14`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMD PPM Provisioning File | `ACPI\AMDI0052` | ACPI-enumerated PnP hardware ID | `AMDPPMPF_DEV` | Native | Native | Native | Native |

### `d3_Data1.cab_805a7fef6dd0\amdpsp.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdsfhkmdf.inf`

- Driver version: `1.0.0.330`; Class: `System`; KMDF: `1.15`; UMDF: `NotDeclared`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMD Sensor Fusion Hub | `PCI\VEN_1022&DEV_15E4` | PCI-enumerated PnP hardware ID | `amdsfhkmdf_Device` | Native | Native | Native | Native |

### `d3_Data1.cab_805a7fef6dd0\amdsfhkmdfi2c.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdsfhspbi2c.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdsfhumdf.inf`

- Driver version: `1.0.0.330`; Class: `Sensor`; KMDF: `NotDeclared`; UMDF: `2.15.0`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMD UMDF Sensor | `ACPI\AMDI0080` | ACPI-enumerated PnP hardware ID | `amdsfhumdf_Inst` | Native | Native | Native | Native |

### `d3_Data1.cab_805a7fef6dd0\amduart.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdusb4cm.inf`

- Driver version: `1.0.0.22`; Class: `System`; KMDF: `1.19`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_805a7fef6dd0\amdusb4pcifilter.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdusbhubfilter.inf`
...
### `d3_Data1.cab_805a7fef6dd0\amdwirelessbutton.inf`
...
### `d3_Data1.cab_805a7fef6dd0\ams_mailboxdrv.inf`
...
### `d3_Data1.cab_805a7fef6dd0\smbusamd.inf`
...
### `d3_Data1.cab_805a7fef6dd0\usbfilter.inf`
...
### `d3_Data1.cab_805a7fef6dd0\zenpromnf.inf`
