# AMD Chipset Software 6.05.28.016 - Windows Server static analysis
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Windows Server 2016 | 24 | 0 | 0 | 0 | 4 | 93 | 0 |
| Windows Server 2019 | 26 | 0 | 0 | 0 | 2 | 95 | 0 |
| Windows Server 2022 | 25 | 0 | 0 | 0 | 3 | 87 | 0 |
| Windows Server 2025 | 26 | 0 | 0 | 0 | 2 | 88 | 0 |

## Device-driver details

### `d3_Data1.cab_a0f54bf860e1\amd3dvcache.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdas4.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdcir.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdgpio2.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdgpio3.inf`

- Driver version: `3.0.1.0000`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_a0f54bf860e1\amdi2c.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdinterface.inf`

- Driver version: `2.0.0.18`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_a0f54bf860e1\amdiov.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdmicropep.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdoemprov.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdpcidev.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdpmf.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdppmpf.inf`

- Driver version: `8.0.0.32`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMD PPM Provisioning File | `ACPI\AMDI0052` | ACPI-enumerated PnP hardware ID | `AMDPPMPF_DEV` | Native | Native | Native | Native |

### `d3_Data1.cab_a0f54bf860e1\amdpsp.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdsfhkmdf.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdsfhkmdfi2c.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdsfhspbi2c.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdsfhumdf.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amduart.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdusb4cm.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdusb4net.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdusb4pcifilter.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdusbhubfilter.inf`
...
### `d3_Data1.cab_a0f54bf860e1\amdwirelessbutton.inf`
...
### `d3_Data1.cab_a0f54bf860e1\ams_mailboxdrv.inf`

- Driver version: `4.0.0.759`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMS-MailBoxDrv | `ACPI\AMDI0090` | ACPI-enumerated PnP hardware ID | `AMS-MailBoxDrv_Device` | Native | Native | Native | Native |

### `d3_Data1.cab_a0f54bf860e1\smbusamd.inf`
...
### `d3_Data1.cab_a0f54bf860e1\usbfilter.inf`
...
### `d3_Data1.cab_a0f54bf860e1\zenpromnf.inf`
