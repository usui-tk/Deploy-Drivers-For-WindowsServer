# AMD Chipset Software 4.06.10.651 - Windows Server static analysis
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Windows Server 2016 | 24 | 0 | 0 | 0 | 0 | 68 | 0 |
| Windows Server 2019 | 24 | 0 | 0 | 0 | 0 | 68 | 0 |
| Windows Server 2022 | 24 | 0 | 0 | 0 | 0 | 68 | 0 |
| Windows Server 2025 | 24 | 0 | 0 | 0 | 0 | 68 | 0 |

## Device-driver details

### `d3_Data1.cab_6064c00ba69a\amdas4.inf`
...
### `d3_Data1.cab_6064c00ba69a\amdcir.inf`
...
### `d3_Data1.cab_6064c00ba69a\amdgpio2.inf`
...
### `d3_Data1.cab_6064c00ba69a\amdgpio3.inf`
...
### `d3_Data1.cab_6064c00ba69a\amdi2c.inf`
...
### `d3_Data1.cab_6064c00ba69a\amdiov.inf`
...
### `d3_Data1.cab_6064c00ba69a\amdmicropep.inf`

- Driver version: `1.0.34.0`; Class: `System`; KMDF: `1.11`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_6064c00ba69a\amdpcidev.inf`

- Driver version: `1.0.0.89`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_6064c00ba69a\amdpmf.inf`

- Driver version: `22.0.1.4`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_6064c00ba69a\amdppmpf.inf`

- Driver version: `1.0.0.11`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMD PPM Provisioning File | `ACPI\AMDI0052` | ACPI-enumerated PnP hardware ID | `AMDPPMPF_DEV` | Native | Native | Native | Native |

### `d3_Data1.cab_6064c00ba69a\amdpsp.inf`

- Driver version: `5.19.0.0`; Class: `SecurityDevices`; KMDF: `1.11`; UMDF: `NotDeclared`
...
| AMD PSP Device | `PCI\VEN_1022&DEV_14CA` | PCI-enumerated PnP hardware ID | `amdpsp_Device` | Native | Native | Native | Native |
...
### `d3_Data1.cab_6064c00ba69a\amdsfhkmdf.inf`

- Driver version: `1.0.0.327`; Class: `System`; KMDF: `1.15`; UMDF: `NotDeclared`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMD Sensor Fusion Hub | `PCI\VEN_1022&DEV_15E4` | PCI-enumerated PnP hardware ID | `amdsfhkmdf_Device` | Native | Native | Native | Native |

### `d3_Data1.cab_6064c00ba69a\amdsfhkmdfi2c.inf`
...
### `d3_Data1.cab_6064c00ba69a\amdsfhspbi2c.inf`
...
### `d3_Data1.cab_6064c00ba69a\amdsfhumdf.inf`

- Driver version: `1.0.0.327`; Class: `Sensor`; KMDF: `NotDeclared`; UMDF: `2.15.0`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMD UMDF Sensor | `ACPI\AMDI0080` | ACPI-enumerated PnP hardware ID | `amdsfhumdf_Inst` | Native | Native | Native | Native |

### `d3_Data1.cab_6064c00ba69a\amduart.inf`
...
### `d3_Data1.cab_6064c00ba69a\amdusb4cm.inf`

- Driver version: `1.0.0.19`; Class: `System`; KMDF: `1.19`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_6064c00ba69a\amdusb4pcifilter.inf`
...
### `d3_Data1.cab_6064c00ba69a\amdusbhubfilter.inf`

- Driver version: `1.0.0.6`; Class: `USB`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_6064c00ba69a\amdwirelessbutton.inf`
...
### `d3_Data1.cab_6064c00ba69a\ams_mailboxdrv.inf`

- Driver version: `1.0.0.394`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMS-MailBoxDrv | `ACPI\AMDI0090` | ACPI-enumerated PnP hardware ID | `AMS-MailBoxDrv_Device` | Native | Native | Native | Native |

### `d3_Data1.cab_6064c00ba69a\smbusamd.inf`
...
### `d3_Data1.cab_6064c00ba69a\usbfilter.inf`
...
### `d3_Data1.cab_6064c00ba69a\zenpromnf.inf`

- Driver version: `1.0.0.10`; Class: `NetService`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
