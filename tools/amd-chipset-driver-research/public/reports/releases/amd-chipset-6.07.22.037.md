# AMD Chipset Software 6.07.22.037 - Windows Server static analysis
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Windows Server 2016 | 24 | 0 | 0 | 0 | 4 | 97 | 0 |
| Windows Server 2019 | 26 | 0 | 0 | 0 | 2 | 99 | 0 |
| Windows Server 2022 | 25 | 0 | 0 | 0 | 3 | 91 | 0 |
| Windows Server 2025 | 26 | 0 | 0 | 0 | 2 | 92 | 0 |

## Device-driver details

### `d3_Data1.cab_c83e731d9acc\amd3dvcache.inf`

- Driver version: `1.0.0.9`; Class: `System`; KMDF: `1.15`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_c83e731d9acc\amdas4.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdcir.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdgpio2.inf`

- Driver version: `2.2.0.133`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_c83e731d9acc\amdgpio3.inf`

- Driver version: `3.0.2.0000`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_c83e731d9acc\amdi2c.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdinterface.inf`

- Driver version: `2.0.0.20`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_c83e731d9acc\amdiov.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdmicropep.inf`

- Driver version: `1.0.43.1`; Class: `System`; KMDF: `1.11`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_c83e731d9acc\amdoemprov.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdpcidev.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdpmf.inf`

- Driver version: `24.0.4.0`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_c83e731d9acc\amdppmpf.inf`

- Driver version: `8.0.0.38`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMD PPM Provisioning File | `ACPI\AMDI0052` | ACPI-enumerated PnP hardware ID | `AMDPPMPF_DEV` | Native | Native | Native | Native |

### `d3_Data1.cab_c83e731d9acc\amdpsp.inf`

- Driver version: `5.32.0.00`; Class: `SecurityDevices`; KMDF: `1.13`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_c83e731d9acc\amdsfhkmdf.inf`

- Driver version: `1.0.0.339`; Class: `System`; KMDF: `1.15`; UMDF: `NotDeclared`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMD Sensor Fusion Hub | `PCI\VEN_1022&DEV_15E4` | PCI-enumerated PnP hardware ID | `amdsfhkmdf_Device` | Native | Native | Native | Native |

### `d3_Data1.cab_c83e731d9acc\amdsfhkmdfi2c.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdsfhspbi2c.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdsfhumdf.inf`

- Driver version: `1.0.0.339`; Class: `Sensor`; KMDF: `NotDeclared`; UMDF: `2.15.0`
...
### `d3_Data1.cab_c83e731d9acc\amduart.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdusb4cm.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdusb4net.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdusb4pcifilter.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdusbhubfilter.inf`
...
### `d3_Data1.cab_c83e731d9acc\amdwirelessbutton.inf`

- Driver version: `1.0.0.5`; Class: `HIDClass`; KMDF: `1.15`; UMDF: `NotDeclared`
...
### `d3_Data1.cab_c83e731d9acc\ams_mailboxdrv.inf`

- Driver version: `4.0.0.833`; Class: `System`; KMDF: `NotDeclared`; UMDF: `NotDeclared`

| Device | Device identifier | Identifier type | Install section | WS2016 | WS2019 | WS2022 | WS2025 |
|---|---|---|---|---|---|---|---|
| AMS-MailBoxDrv | `ACPI\AMDI0090` | ACPI-enumerated PnP hardware ID | `AMS-MailBoxDrv_Device` | Native | Native | Native | Native |

### `d3_Data1.cab_c83e731d9acc\smbusamd.inf`
...
### `d3_Data1.cab_c83e731d9acc\usbfilter.inf`
...
### `d3_Data1.cab_c83e731d9acc\zenpromnf.inf`

- Driver version: `1.0.0.20`; Class: `NetService`; KMDF: `NotDeclared`; UMDF: `NotDeclared`
