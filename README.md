...
W1-W7 have landed** — Windows Driver Policy + kernel-image trust evidence,
...
measured-PnP-rank split, and the security-narrative closure. **Still
open**: the P1 closeout items (kernel-trust evidence completion,
download-override separation, base-policy machine verification) and all
of P2. No post-remediation field
