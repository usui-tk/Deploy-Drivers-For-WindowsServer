...
| Windows Server 2019 | 17763 | **Path C (外部オーケストレータ経由のレガシー WDAC SPF)** | r67+ で追加された新規パス。 パイロット検証実施待機中。 |
| Windows Server 2016 | 14393 | **Path C (外部オーケストレータ経由のレガシー WDAC SPF)** | Path C はこの build もカバーします。 |
