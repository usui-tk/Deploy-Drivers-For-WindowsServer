...
現時点の最新リリースは **Chipset r60 / Graphics r28 / NPU r10 / BthPan r10**
(2026-05-18) で、 4 スクリプトを psa.py 3.2.0 ベースラインに揃えるクロススクリプト整合パスです。 前回リリース (r59 / r27 / r9 / r9、 2026-05-17) で導入された Debug Trace Facility (SECTION 1b) が現時点のヘッドライン機能となります。
